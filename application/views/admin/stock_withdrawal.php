                            ...
                            <div class="col-md-10">
                              <form role="form" method="POST" action="<?php echo base_url() ?>admin/action/new_swa" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      ...
                                      <div class="col-md-6 col-xs-12">
                                        <label>&nbsp;</label>
                                        <input type="text" autocomplete="off" id="" name="" class="form-control" placeholder="Others, please specify">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
                                      <div class="col-md-3 col-xs-12">
                                        <label>TO</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" readonly="readonly" id="sub_code" name="sub_code" placeholder="Search subsidiary">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <label>&nbsp;</label>
                                            <input type="text" readonly="readonly" id="sub_descript" name="sub_descript" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                  <hr class="rounded">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="sup_code" placeholder="Search supplier" readonly="readonly">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-sm btn-success assign-supplier-btn" data-toggle="modal" data-target="#assignSupplierModal" type="button">
                                                        <i class="nav-icon fa fa-search"></i>
                                                    </button>
                                                </span>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <label>&nbsp;</label>
                                            <input type="text" readonly="readonly" id="sup_name" name="sup_name" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                  <div class="row">
                                    <div class="col-md-6 col-xs-12">
                                      ...
                                      <textarea  autocomplete="off" type="text" name="" id="" class="form-control" placeholder=""></textarea>
                                    </div>
                                    <div class="col-md-6 col-xs-12">
                                      <label>REMARKS</label>
                                      <textarea  autocomplete="off" type="text" name="" id="" class="form-control" placeholder=""></textarea>
                                ...
                                <div class="form-group">
                                  ...
                                  <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#assignPromoDetailsModal">PROMO DETAILS</button>
...
<!-- -------------------------------     SUPPLIER MODAL     --------------------------------------  -->
<div class="modal fade" id="assignSupplierModal" tabindex="-1" role="dialog" aria-labelledby="assignSupplierModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content modal-scrollable">
      <div class="modal-header">
        <h5 class="modal-title" id="assignSupplierModalLabel">Supplier List</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <table class="table table-hover table-bordered table-striped" >
          ...
          <tbody id="myTable1">
            ...
            <?php  
                $count = 1;
                $this->db->order_by('creation_date', 'ASC');
                $supplier = $this->db->get('sup_tbl' ,10)->result_array();
                ...
                <tr>
                  ...
                  <td>
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input supplier-checkbox" id="supplier_<?php echo $row['ID']; ?>">
                    <label class="form-check-label" for="supplier_<?php echo $row['ID']; ?>"></label>
                  </div>
                  </td>
                </tr>
                <?php  
...
//MODAL-----------------------------------------
        ...
        $(document).ready(function() {
            ...
            if ($(this).is(":checked")) {
                // Get the selected subsidiary's code
                var selectedCode = $(this).closest("tr").find("td:nth-child(2)").text();
                var selectedSupplierName = $(this).closest("tr").find("td:nth-child(3)").text();
                // Set the selected code in the input field
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              <label>RECEIVED BY</label>
                <input autocomplete="off" value="<?php ?>" type="text" name="" class="form-control" placeholder="Received by">
              <label></label>
                <input autocomplete="off" type="date" value="<?php  ?>" name="" class="form-control" placeholder="Date">
            </div>
            <div class="modal-footer">
...
<!--------------------------------------   PROMO DETAIL MODAL  ---------------------------------------->
<div class="modal fade" id="assignPromoDetailsModal" tabindex="-1" role="dialog" aria-labelledby="assignPromoDetailsModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content modal-scrollable">
      <div class="modal-header">
          ...
          <div class="card-body">
            <div class="form-group">
              <label>PROMO TITLE</label>
                <input autocomplete="off" value="<?php ?>" type="text" name="" class="form-control" placeholder="">
            </div>
            <div class="form-group">
              <label>PROMO MECHANICS</label>
                <textarea autocomplete="off" value="<?php ?>" type="text" name="" class="form-control" placeholder=""></textarea>
            </div>
            <div class="form-group">
