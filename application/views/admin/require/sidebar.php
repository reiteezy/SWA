                ...
                <div class="pcoded-inner-navbar main-menu">
                    ...
                    <ul class="pcoded-item pcoded-left-item">
                        ...
                        <li class="pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                ...
                                <li class>
                                    <a href="<?php echo base_url() ?>SupplierController/add_supplier" class="waves-effect waves-dark">
                    ...
                    <ul class="pcoded-item pcoded-left-item">
                        <li class="pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                <li class>
                                    <a href="<?php echo base_url() ?>SwaController/swa_list" class="waves-effect waves-dark">
                                        <span class="pcoded-mtext">SWA List</span>
                                        <span class="pcoded-badge label label-info ">NEW</span>
                                    </a>
                                </li>
                                <li class>
                                    <a href="<?php echo base_url() ?>SwaController/swa_form" class="waves-effect waves-dark">
                        ...
                        <li class="pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                <li class>
                                    <a href="<?php echo base_url() ?>SwaController/per_list" class="waves-effect waves-dark">
                                        <span class="pcoded-mtext">PER List</span>
                                        <span class="pcoded-badge label label-info ">NEW</span>
                                    </a>
                                </li>
                                <li class>
                                    <a href="<?php echo base_url() ?>SwaController/per_form" class="waves-effect waves-dark">
                    ...
                    <ul class="pcoded-item pcoded-left-item">
                        <li class="pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                <li class=" ">
                                    <a href="<?php echo base_url() ?>ClassController/class_list" class="waves-effect waves-dark">
                                        <span class="pcoded-mtext">User Type List</span>
                                    </a>
                                </li>
                                <li class=" ">
                                    <a href="<?php echo base_url() ?>ClassController/add_class" class="waves-effect waves-dark">
                        ...
                        <li class="pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                <li class=" ">
                                    <a href="<?php echo base_url() ?>UserController/users" class="waves-effect waves-dark">
                                        <span class="pcoded-mtext">Users List</span>
                                    </a>
                                </li>
                                <li class=" ">
                                    <a href="<?php echo base_url() ?>UserController/add_user_page" class="waves-effect waves-dark">
