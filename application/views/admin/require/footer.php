...
<script src="<?= base_url('assets/'); ?>bower_components/datatables.net/js/dataTables.dateTime.min.js"></script>
<script src="<?= base_url('assets/'); ?>bower_components/datatables.net/js/moment.min.js"></script>

<script src="<?= base_url('assets/'); ?>assets/pages/data-table/js/data-table-custom.js"></script>
