...
<div class="card table-card user-card">
    ...
    <nav class="navbar second-navbar navbar-expand-lg navbar-light" style="background: transparent">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#perlist" role="tab">PROMO EXECUTION
                        REPORT LIST</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#perform" role="tab">PROMO EXECUTION REPORT
                        FORM</a>
                </li>
            </ul>
    ...
    <div class="tab-content tabs card-block">
        <div class="tab-pane active" id="perlist" role="tabpanel">
            <div class="card-header">
                <h5>Promo Execution Report List</h5>
            </div>
        ...
        <div class="tab-pane" id="perform" role="tabpanel">
            <div class="card-header">
                    ...
                    <div class="col-md-12">
                        <form class="perForm" role="form" id="perForm" method="POST" action=""
                            ...
                            <div class="row" style="margin-top: -15px;">
                                ...
                                <div class="col-md-3 col-xs-12">
                                    <label class="sm-label" for="document_date" style="cursor: pointer;">Date</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-12">
                                    ...
                                    <div style="position: relative;">
                                        <input autocomplete="off" type="text" id="swa_series_no" name="swa_series_no"
                                            class="form-control">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <input type="reset" value="Clear" id="clearForm"
                                            style="width: 150px; margin-right: 8px;" class="btn btn-sm btn-secondary"
                                            data-toggle="tooltip" title="Clear form">
                        ...
                        <form role="form" method="POST" action="<?php echo base_url() ?>#"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label></label>
                                    <input autocomplete="on" type="date" value="<?php  ?>" id="audit_date"
                                        name="audit_date" class="form-control" placeholder="Date">
                                </div>
                                <div class="form-group">
                                    ...
                                    <label></label>
                                    <input autocomplete="on" type="date" value="<?php  ?>" id="note_date"
                                        name="note_date" class="form-control" placeholder="Date">
                                </div>
